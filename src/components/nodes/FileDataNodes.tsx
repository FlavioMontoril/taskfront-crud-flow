    ...
    return (
        <div className="bg-white shadow-md rounded-md p-4 border border-gray-300 w-80 h-auto">
            ...
            <div className="bg-gray-50 rounded-lg p-3 mb-4 border-l-4 border-blue-400">
                <p className="text-sm text-gray-700 leading-relaxed break-words">Nome: {data?.file?.original_name}</p>
                <p className="text-sm text-gray-700 leading-relaxed break-words">Criado em: {data?.file?.createdAt}</p>
            ...
            <ViewFileNode isOpen={isOpen} onClose={() => setIsOpen(false)} fileUrl={url!} />
